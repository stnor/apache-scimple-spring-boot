...
import com.selessia.scim.framework.rest.BaseResourceTypeResourceImpl;
...
public interface Provider<T extends ScimResource> {
    ...
    /**
     * Allows the SCIM com.selessia.scim.scim12kserver.server's REST implementation to create a resource via
    ...
    /**
     * Allows the SCIM com.selessia.scim.scim12kserver.server's REST implementation to update and existing
