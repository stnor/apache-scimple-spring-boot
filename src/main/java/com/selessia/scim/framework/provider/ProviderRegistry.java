...
package com.selessia.scim.framework.provider;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.selessia.scim.framework.schema.Registry;
import com.selessia.scim.framework.exception.InvalidProviderException;
import com.selessia.scim.framework.exception.UnableToRetrieveExtensionsException;
import edu.psu.swe.scim.common.ScimUtils;
import edu.psu.swe.scim.spec.annotation.*;
...
public class ProviderRegistry {
  ...
  ScimExtensionRegistry scimExtensionRegistry = ScimExtensionRegistry.getInstance();
  ...
  public <T extends ScimResource> void registerProvider(Class<T> clazz, Provider<T> providerInstance) throws InvalidProviderException, JsonProcessingException, UnableToRetrieveExtensionsException {

    Provider<T> provider = providerInstance;
  ...
  public <T extends ScimResource> Provider<T> getProvider(Class<T> clazz) {
    Provider<? extends ScimResource> providerInstance = providerMap.get(clazz);
    return (Provider<T>) providerInstance;
  }
