...
import com.selessia.scim.framework.exception.UnableToCreateResourceException;
import com.selessia.scim.framework.exception.UnableToDeleteResourceException;
import com.selessia.scim.framework.exception.UnableToRetrieveResourceException;
...
//  }
    ...
    @Autowired
    UpdateRequest<ScimResource> updateRequestInstance;
    ...
    public Response doBulk(BulkRequest request, UriInfo uriInfo) {
        ...
        for (IWishJavaHadTuples iwjht : allUnresolveds) {
            ...
            try {
                ...
                UpdateRequest<ScimResource> updateRequest = updateRequestInstance;
